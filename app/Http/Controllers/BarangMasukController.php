...
class BarangMasukController extends Controller
{
    ...
    {
        $kodeMasuk = BarangMasuk::generateKode();
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
            BarangMasuk::create([
                ...
                'harga_beli_saat_ini' => $request->harga_beli,       // fix: harga_beli → harga_beli_saat_ini
                // total_harga DIHAPUS → generated column otomatis
