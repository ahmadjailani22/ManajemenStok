                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="menipis" {{ $filterStatus == 'menipis' ? 'selected' : '' }}>Menipis
                                        </option>
                                        <option value="habis" {{ $filterStatus == 'habis' ? 'selected' : '' }}>Habis
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                        ...
                        <table class="table table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                @foreach ($barang as $index => $b)
                                    ...
                                    <tr
                                        class="{{ $status === 'habis' ? 'table-danger' : ($status === 'menipis' ? 'table-warning' : '') }}">
