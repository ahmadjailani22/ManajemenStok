        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title pt-1">
                    <i class="fas fa-plus-circle mr-2 text-primary"></i>Form Tambah Supplier
                </h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-light text-muted font-weight-bold"
                                value="{{ $kodeSupplier }}" readonly disabled>
                        </div>
                        <small class="text-muted"><i class="fas fa-info-circle mr-1"></i>Kode dibuat otomatis oleh sistem.</small>
                    </div>
